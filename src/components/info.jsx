...
export default function Info() {
    return (
      <div id="infodiv">
        ...
        metacritic and rottentomatoes. Api that are used are <a href="https://www.omdbapi.com" target="_Blank">omdbapi.com</a> and <a href="api.themoviedb.org">themoviedb.org</a>.<br/>
